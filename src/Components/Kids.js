...
import im1 from "../images/kimg1.png";
import im2 from "../images/kimg2.png";
import im3 from "../images/kimg3.png";
import im4 from "../images/kimg4.png";
...
const categories = [
 ...
 function Kids() {
  ...
  return (
    <Box sx={{ p: { xs: 2, sm: 3 }, minHeight: "100vh", mt:{xs:7}, backgroundColor: "#fff" }}>
      {/* Page Heading */}
      <Typography
        variant="h5"
        sx={{
        ...
        {categories.map((item) => (
          ...
          >
            ...
            <CardMedia
              ...
              image={item.image}
              alt={item.title}
        sx={{ height: { xs: 200, sm: 300 },marginTop:{xs:2}, objectFit: "cover" }}
            />
